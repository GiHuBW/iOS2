...
@interface SingleBuyTableViewCell ()
...
@end
@implementation SingleBuyTableViewCell
...
- (void)setSingleList:(SingleBuyModle *)singleList{
    [_goodsImage downloadImage:singleList.ImgView place:[UIImage imageNamed:@"桌面"]];
    [_countryImage downloadImage:singleList.CountryImg place:[UIImage imageNamed:@"桌面"]];
    ...
    _priceLabel.attributedText = [NSMutableAttributedString makeStrikethroughAttributedString:singleList.Price :singleList.DomesticPrice rebateString:nil];
}
