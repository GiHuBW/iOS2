...
-(UITextField *)phoneNum{
    if (!_phoneNum) {
        ...
        _phoneNum.borderStyle = UIKeyboardTypeNumberPad;
    }
    return _phoneNum;
}
...
-(UIButton *)login{
    if (!_login) {
        ...
        [_login setImage:[[UIImage imageNamed:@"登录界面登录按钮"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
